...
const STAGING_METRICS: readonly EvidenceMetric[] = [
  ...
  meta({ id: 'demo-metric-contributions-2026-08', kind: 'evidence-metric', state: 'live', source: 'staging-seed', revision, demo: true, label: { id: 'Kontribusi program tercatat', en: 'Recorded program contributions' }, value: '8', period: { id: 'Siklus contoh 03 · 2026', en: 'Sample cycle 03 · 2026' }, updatedAt: '2026-08-03', definition: { id: 'Kontribusi contoh yang ditautkan ke program pada siklus berjalan.', en: 'Sample contributions linked to a program in the current cycle.' }, sourceLabel: { id: 'Dataset pratinjau', en: 'Preview dataset' }, method: { id: 'Hitung catatan kontribusi contoh yang memiliki program.', en: 'Count fictional contribution records linked to a program.' } }),
