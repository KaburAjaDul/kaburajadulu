...
const COPY: Record<'id' | 'en', Record<CommunityPageKind, CommunityCopy>> = {
  id: {
    ...
    programs: { eyebrow: 'Program komunitas', title: 'Pilih kegiatan yang bisa benar-benar kamu tindak lanjuti.', description: 'Setiap kartu menunjukkan sumbernya, apa yang sudah diketahui, dan bagian yang masih perlu ditanyakan sebelum kamu ikut.', actions: { discord: 'Tanyakan jadwal terbaru', support: 'Dukung KAD', back: 'Kembali', detail: 'Baca rincian' }, states: { empty: 'Belum tersedia', pending: 'Perlu konfirmasi', notPublished: 'Belum dipublikasikan', demo: 'Data simulasi' } },
    ...
    events: { eyebrow: 'Agenda komunitas', title: 'Tahu apa yang berlangsung sebelum menyisihkan waktu.', description: 'Waktu, durasi, status, dan langkah berikutnya ditempatkan di satu tempat. Jadwal nyata hanya terbit setelah diperiksa.', actions: { discord: 'Tanyakan jadwal terbaru', support: 'Dukung KAD', back: 'Kembali', detail: 'Baca rincian' }, states: { empty: 'Belum ada agenda publik', pending: 'Sedang diperiksa', notPublished: 'Belum dipublikasikan', demo: 'Data simulasi' } },
    ...
    volunteer: { eyebrow: 'Kerja relawan', title: 'Pilih pekerjaan kecil yang bisa dituntaskan bersama.', description: 'Setiap siklus membagi pekerjaan berdasarkan program, memberi pemilik yang jelas, lalu meninggalkan catatan untuk tim berikutnya.', actions: { discord: 'Lihat cara mulai', support: 'Dukung KAD', back: 'Kembali', detail: 'Baca rincian' }, states: { empty: 'Belum tersedia', pending: 'Menunggu izin', notPublished: 'Belum dipublikasikan', demo: 'Data simulasi' } },
    stories: { eyebrow: 'Cerita komunitas', title: 'Lihat kerja di balik komunitas, dengan izin orang yang mengerjakannya.', description: 'Cerita hanya terbit setelah isi, media, dan cara menyebut kontributor disetujui.', actions: { discord: 'Bagikan bahan cerita', support: 'Dukung KAD', back: 'Kembali', detail: 'Baca rincian' }, states: { empty: 'Belum ada cerita terbit', pending: 'Menunggu persetujuan', notPublished: 'Belum dipublikasikan', demo: 'Data simulasi' } },
  ...
  en: {
    ...
    programs: { eyebrow: 'Community programs', title: 'Choose something you can actually follow through on.', description: 'Each card shows its source, what is known, and what still needs confirmation before you join.', actions: { discord: 'Ask for the latest schedule', support: 'Support KAD', back: 'Back', detail: 'Read details' }, states: { empty: 'Not available yet', pending: 'Needs confirmation', notPublished: 'Not published', demo: 'Demo data' } },
    ...
    events: { eyebrow: 'Community schedule', title: 'Know what is happening before you set aside the time.', description: 'Time, duration, status, and the next step live in one place. Real schedules publish only after review.', actions: { discord: 'Ask for the latest schedule', support: 'Support KAD', back: 'Back', detail: 'Read details' }, states: { empty: 'No public events yet', pending: 'Under review', notPublished: 'Not published', demo: 'Demo data' } },
    ...
    volunteer: { eyebrow: 'Volunteer work', title: 'Choose a small piece of work the team can finish together.', description: 'Each cycle groups work by program, gives it a clear owner, and leaves useful context for the next team.', actions: { discord: 'See how to start', support: 'Support KAD', back: 'Back', detail: 'Read details' }, states: { empty: 'Not available yet', pending: 'Permission required', notPublished: 'Not published', demo: 'Demo data' } },
    stories: { eyebrow: 'Community stories', title: 'Stories to check, not guess.', description: 'Attribution, transcript, media, and final publication wait for editorial approval and consent.', actions: { discord: 'Share context', support: 'Support KAD', back: 'Back', detail: 'View details' }, states: { empty: 'No published stories yet', pending: 'Pending approval', notPublished: 'Not published', demo: 'Demo data' } },
